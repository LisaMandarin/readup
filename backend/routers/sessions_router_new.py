...
async def create_session(
    ...
    # Create first passage in the session using TranslationService
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Failed to save initial passage: {str(e)}"
        )
...
async def create_passage_in_session(
    ...
    # Create new passage using enhanced TranslationService
    try:
...
async def update_passage(
    ...
    """Update a passage using enhanced TranslationService"""
    try:
...
async def validate_session_translations(
    ...
    """
    Validate all translations in a session for data integrity
    Useful for Tigbo quality assurance
    """
    # Verify session exists and belongs to user
    session = (
        db.query(SessionModel)
