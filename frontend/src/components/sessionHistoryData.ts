...
const sessionHistoryData: SessionHistoryRecord[] = [
  {
    ...
    updatedAt: new Date('2026-03-28T02:32:00+08:00'),
  },
  {
    userID: 'user-1042',
    ...
    passage:
      'A balanced study routine should include short breaks, clear goals for each session, and enough sleep to support memory retention and concentration.',
